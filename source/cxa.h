 ...
 */
#define CXA_SET_STR(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_STR, s}
#define CXA_SET_CHR(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_CHR, s}
#define CXA_SET_SHT(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_SHT, s}
#define CXA_SET_INT(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_INT, s}
#define CXA_SET_LNG(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_LNG, s}
#define CXA_SET_DBL(l,d,D,h,s)   {l, d, D, 0, h, CXA_FLAG_ARG_TYPE_DBL, s}
